#!/usr/bin/env python3
"""Corpus feature regeneration v6 (Phase 3 iter 33): SimForge v6 renderer — the renderer changed (impulsive
...
OUT = Path("experiments/corpus_v6")


def one(i):
    truth = []
    m, x = V6.sample_run(i, truth=truth)
